...
a persistence unit "Test-RestPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/test/p59/Test_Rest/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "Test-Rest/pom.xml":
...
artifact ("Test-Rest.war") is already built. You can build
